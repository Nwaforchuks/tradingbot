...
export default function Howtodepo() {
  ...
  return (
    <div className='flex flex-col overflow-auto mb-32'>
        ...
        • Please make sure you deposit with the crypto wallet/address you registered with, because the wallet address will be used for crediting your deposits into your account.<br></br><br></br>
